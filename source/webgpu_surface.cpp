...
wgpu::Surface SDL_GetWGPUSurface( const wgpu::Instance& instance, SDL_Window* window )
{
    ...
    descriptorHwnd.hinstance = SDL_GetProperty( SDL_GetWindowProperties( window ), SDL_PROP_WINDOW_WIN32_INSTANCE_POINTER, NULL );
    descriptorHwnd.hwnd      = SDL_GetProperty( SDL_GetWindowProperties( window ), SDL_PROP_WINDOW_WIN32_HWND_POINTER, NULL );
